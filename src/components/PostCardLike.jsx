              ...
              <Box key={items.id}>
                ...
                <GradientPaper>
                  <Grid container sx={{ justifyContent: "space-between" }}>
                    ...
                    <Grid sx={{height:'30px', alignItems: 'flex-start', display: 'flex', alignItems: 'center'}}>
                      <Typography
                        noWrap
                        sx={{
                          fontWeight: 500,
                      ...
                      <Grid container sx={{ display:'flex', mt: "3px", mr: '10px',  width:'auto' }}>
                      <Typography
                        sx={{
                          display: "flex",
                          fontWeight: 400,
                    ...
                    <Grid sx={{height:'30px', display: 'flex', alignItems: 'center'}}>
                    ...
                    <Grid sx={{ mr: 1, height:'30px', display: 'flex', alignItems: 'center' }}>
                      <Typography
                        sx={{
                          display: "flex",
                          fontWeight: 400,
