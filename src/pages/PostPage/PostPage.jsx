        ...
        <>
            ...
            >
              ...
              >
                <Grid item sx={{ mr: 2 }}>
                  ...
                  >
                    <FavoriteIcon />
                    {post?.map((item) => item.count_like)} Likes
                  </Typography>
                </Grid>
                <Grid item sx={{ mr: 2 }}>
                  <Typography
                  ...
                  >
                    <ChatBubbleIcon />
                    {post?.map((item) => item.count_message)} Comments
                  </Typography>
                </Grid>
                <Grid item sx={{ mr: 2 }}>
                  <Typography
                  ...
                  >
                    <VisibilityIcon />
                    {post?.map((item) => item.count_watch)} Views
                  </Typography>
                </Grid>
              </Grid>
          ...
          >
            ...
            >
              ...
              >
                <Grid item sx={{ mx: 2, display: "flex", flexDirection: "row"}}>
                  <Typography
                    sx={{
                      display: "flex",
                      fontWeight: 400,
                  ...
                  >
                    {post?.map((item) => item.count_message)}
                  </Typography>
                  <Typography
                    sx={{
                      display: "flex",
              ...
              {activity?.map((item) => (
                <>
                  <Grid container>
                    <Grid item sx={{ m: "12px", display: "flex", alignItems: "center" }}>
                      <Avatar
                        component="a"
                        variant="span"
                        href="/"
